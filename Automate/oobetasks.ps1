...
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/AnyLinQ-B-V/OSDCloud/main/Automate/Set-KeyboardLanguage.ps1" -Wait

#Write-Host -ForegroundColor DarkGray "Executing Product Key Script"
#Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/AnyLinQ-B-V/OSDCloud/main/IAutomate/nstall-EmbeddedProductKey.ps1" -Wait
...
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/AnyLinQ-B-V/OSDCloud/main/Automate/CleanUp.ps1" -Wait
...
Invoke-WebRequest https://github.com/AnyLinQ-B-V/OSDCloud/raw/main/Automate/ServiceUI64.exe -OutFile "C:\OSDCloud\ServiceUI.exe"
